...
Yes, the estimated effect of price on sales is bigger than without the instrument (`r q9_reg2` compared to `r q9_reg1`). This is because using tax as an instrument for price can help reduce the effect of confounders, better revealing the true effect.
